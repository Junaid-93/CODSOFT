        ...
        <div className="bg-white py-5 sm:py-5">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                {blogsData.map((post) => {
                    ...
                    //   <div>
                    //   {/* <div className="mx-auto mt-5 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-5 sm:mt-10 sm:pt-5 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                    //     {posts.map((post) => (
